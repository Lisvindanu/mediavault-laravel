...
return [
    ...
    'description' => 'MediaVault is an offline-first media queue manager that stores metadata only. The backend does NOT handle file uploads - all media files are stored locally on mobile devices.',
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by calling <code>POST /api/register</code> or <code>POST /api/login</code>. Use the token in the Authorization header as <code>Bearer {token}</code>.',
    ],
